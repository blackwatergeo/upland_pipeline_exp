      ...
      add: function(item) {
        ...
        array.forEach(item.links, function(link){
          if(link.popuptype === "text"){
            ...
            var linkImg = domConstruct.toDom("<a href='javascript:void(0);' target='_blank' title='" + link.alias + "'><img src='" + link.icon + "' alt='" + link.alias + "' border='0' width='20px' height='20px'></a>");
